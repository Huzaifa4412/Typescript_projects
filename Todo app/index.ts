...
do {
  ...
  if (ask_user.todo_type === "Single data") {
    let todo_add_single = await inquirer.prompt([
      {
        name: "todo",
        message:
          "Please enter the thing that you want to add it in you TODO list",
        type: "input",
      },
      {
    ...
    if (todo_add_single.todo_confirm === false) {
      todo_list.pop();
      console.log(
        `Your todo ${todo_add_single.todo} is Canceled to your list successfully`
      );
    } else {
      todo_list.push(todo_add_single.todo);
      console.log(
        `Your todo ${todo_add_single.todo} is added to your list successfully`
      );
    }
    ...
    if (todo_add_multiple.todo_confirm === false) {
      todo_list.pop();
      console.log(
        `Your todo ${todo_add_multiple.todo} is Canceled to your list successfully`
      );
    } else {
      todo_list.push(todo_add_multiple.todo);
      console.log(
        `Your todo ${todo_add_multiple.todo} is added to your list successfully`
      );
    }
    let user_preview = await inquirer.prompt({
